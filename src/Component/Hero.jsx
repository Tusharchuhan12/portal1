    ...
    return (
        <section className="relative w-full min-h-screen bg-black text-white flex flex-col justify-between overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10 bg-gradient-to-b from-gray-900 to-black" />
                ...
                <div className="flex flex-col-reverse md:flex-row items-center justify-between max-w-7xl mx-auto px-4 sm:px-8 pt-24 md:pt-36 gap-8 w-full h-full flex-1">
                    {/* Your content here */}
                ...
                <div className="flex justify-center items-center w-full md:w-1/2 mb-8 md:mb-0">
                    <img
                        className="w-48 xs:w-64 sm:w-80 md:w-[320px] lg:w-[400px] h-auto max-h-[420px] object-cover rounded-2xl shadow-2xl border border-white/10 bg-white/10 sm:mt-4"
                        src="photo2.jpg"
                        alt="Tushar Chauhan"
            ...
            <div className="w-full flex justify-center items-center pb-8 md:pb-12">
